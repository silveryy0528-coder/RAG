...
RAG_PROMPT = (
    ...
    "Return only the minimal noun phrase or title requested by the question.\n"
    "Do not add time ranges, dates, employers, locations, or extra details unless explicitly asked.\n"
    "Do not explain your answer unless the question explicitly asks for explanation.\n"
    ...
    "For title, publication, role, or similar questions, answer only the title/name/role itself.\n"
    "Skip filler words such as 'the title is' or 'the role was'.\n"
